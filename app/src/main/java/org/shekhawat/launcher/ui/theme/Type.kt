...
// Available font families (built-in system fonts)
val FONT_OPTIONS = listOf("Default", "Serif", "Monospace", "Cursive", "Sans Serif")
...
// Default typography (used when no font preference is set)
val Typography = typographyWithFont(FontFamily.Default)
